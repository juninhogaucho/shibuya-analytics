...
export const MARKET_PRICING: Record<Market, PricingCatalog> = {
  global: {
    ...
    audit_once: {
      ...
      description:
        'A legacy bounded reset window built to expose whether your current issue is structural, behavioral, or state-driven before you commit to continuity.',
      perks: [
    ...
    reset_once: {
      ...
      billingLabel: 'one time',
      description:
        'A legacy bounded premium reset package for traders who need a harder intervention, deeper surfaces, and a guided review to lock the reset.',
      perks: [
  ...
  india: {
    audit_monthly: {
      ...
      billingLabel: '/month',
      description:
        'Built for Indian retail F&O traders who want the Shibuya software loop alive month after month so repeat mistakes can actually shrink, not just be diagnosed once.',
      perks: [
        'Persistent live trader workspace',
    ...
    audit_once: {
      ...
      billingLabel: 'one time',
      description:
        'The legacy India entry offer: one account, manual upload, a 30-day live window, and a clear answer to whether the issue is edge, behavior, or both.',
      perks: [
      ...
      ctaLabel: 'Start Legacy Psych Audit',
      supportTier: 'self-serve',
      accessWindowDays: 30,
      uploadLimit: 1,
      guidedReviewIncluded: false,
    ...
    reset_once: {
      ...
      billingLabel: 'one time',
      description:
        'The premium legacy bounded India reset package for traders who need stronger intervention, deeper surfaces, and one guided kickoff review to force the reset.',
      perks: [
        'Everything in Psych Audit',
        'Deeper alerts, prescriptions, and slump workflow',
