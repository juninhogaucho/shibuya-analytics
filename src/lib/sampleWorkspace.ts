...
export const SAMPLE_WORKSPACE_DATA = {
  overview: {
    ...
    risk_model_version: 'risk_v2:2.1.0-sample-contract',
    risk_point_ruin_probability: 0.034,
    risk_decision_ruin_probability: 0.091,
    risk_decision_policy: 'Sample contract: explain the point estimate, but gate decisions on the conservative upper bound once live backend evidence exists.',
    risk_conservative_bound: {
      p_ruin_upper: 0.091,
      p_ruin_p95: 0.14,
      sampling_width: 0.057,
    ...
    risk_evidence_quality: {
      ...
      score: 0.41,
      n_trades: 30,
      loss_observations: 10,
      tail_loss_observations: 3,
      recommended_action: 'Sample contract: do not treat a low point estimate as safety; require append history.',
      reasons: [
        'sample workspace is not live account evidence',
        'history is below strong target of 200 trades',
        'tail-loss coverage is thin',
      ],
    },
