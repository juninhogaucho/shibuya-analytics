...
describe('ResetProDemoCommandCenter', () => {
  test('renders a private demo path with explicit demo boundaries', () => {
    ...
    expect(screen.getByRole('link', { name: /Start Mission HQ/i })).toHaveAttribute('href', '/dashboard?market=india')
    expect(screen.getByRole('link', { name: /Close On Append Proof/i })).toHaveAttribute('href', '/dashboard/upload?market=india')
