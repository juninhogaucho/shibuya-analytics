...
describe('DemoLauncherPage', () => {
  test('renders the controlled Shibuya demo launch packet without printing secrets', () => {
    ...
    expect(screen.getByText('Operator run sheet')).toBeInTheDocument()
  ...
  test('shows private gate disabled state when no demo code is configured', () => {
    render(
      <MemoryRouter initialEntries={['/demo?market=india']}>
        <DemoLauncherPage />
      </MemoryRouter>,
    )
