...
describe('DashboardOverviewPage', () => {
  ...
  test('renders live activation origin separately from sample demo metadata', async () => {
    ...
    expect(screen.getByText(/sample_demo_only; live\/private artifact not proven/i)).toBeInTheDocument()
    ...
    expect(screen.getByText('Normalized trade packet, generated workspace artifacts, and first account-specific mandate.')).toBeInTheDocument()
    expect(screen.getByText('Append must prove')).toBeInTheDocument()
    expect(screen.getByText('Repeat upload history must confirm improvement, relapse, or an unchanged private question before progress is claimed.')).toBeInTheDocument()
