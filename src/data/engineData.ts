...
export const ENGINES: EngineEntry[] = [
  ...
  // ── DECAY ─────────────────────────────────────────────
  {
    ...
    forYou: 'When AFMA flags your London Session FVG setup with 0.87 confidence, it means four independent statistical tests agree the market has changed under that strategy. The setup that made you money last quarter is no longer the same statistical object. Stop trading it until the data changes.',
  ...
  },
  {
    ...
    forYou: 'When the Clayton copula shows \u03BB_L = 0.4 between your EUR/USD and GBP/USD positions, it means there is a 40% probability that when one position hits its extreme loss, the other does too. Your "diversification" is an illusion in the tail.',
