...
const REQUIRED_SURFACES = [
  ...
  },
  {
    ...
    markers: ['Public packet source:', 'Handoff evidence:', 'Validation note:', 'Story handoff:', 'Public pain axes:', 'Private gate checksum:', 'Engagement receipt:', 'Engagement boundary:', 'Receipt id:', 'UNLOCK RECEIPT', 'RESET PRO LIVING MIRROR', 'Story became the product', 'LiveSignal', 'Next Session Mandate', 'RESET PRO CLOSE CONTRACT', 'Live upload, generated backend artifacts, durable account deltas, repeated append history, and trader-specific improvement remain unproven.', 'This receipt proves the presenter gate carried context into the sample workspace.'],
  },
  {
